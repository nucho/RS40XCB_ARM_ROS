...
#        print self.ser.portstr
    ...
    def getAngle(self,sId):
        ...
        param1 =  struct.unpack('B',(self.readbuf[8]))[0]
        param2 =  struct.unpack('B',(self.readbuf[7]))[0]
    ...
    def getTime(self,sId):
        ...
        """
        #readbuf = self._getParam(sId);
        param1 =  struct.unpack('B',(self.readbuf[10]))[0]
        param2 =  struct.unpack('B',(self.readbuf[9]))[0]
    ...
    def getSpeed(self,sId):
        ...
        param1 =  struct.unpack('B',(self.readbuf[12]))[0]
        param2 =  struct.unpack('B',(self.readbuf[11]))[0]
    ...
    def getLoad(self,sId):
        ...
        """
        #readbuf = self._getParam(sId);
        param1 =  struct.unpack('B',(self.readbuf[14]))[0]
        param2 =  struct.unpack('B',(self.readbuf[13]))[0]
        return ((param1 << 8) & 0xFF00) | ((param2) & 0x00FF)
    ...
    def getTemperature(self,sId):
        ...
        """
        #readbuf = self._getParam(sId);
        param1 =  struct.unpack('B',(self.readbuf[16]))[0]
        param2 =  struct.unpack('B',(self.readbuf[15]))[0]
        return ((param1 << 8) & 0xFF00) | ((param2) & 0x00FF)
    ...
    def getVoltage(self,sId):
        ...
        およそ+-0.3V程度の誤差がある
        """
        #readbuf = self.getParam(sId);
        param1 =  struct.unpack('B',(self.readbuf[18]))[0]
        param2 =  struct.unpack('B',(self.readbuf[17]))[0]
        return ((param1 << 8) & 0xFF00) | ((param2) & 0x00FF)
    ...
    def getParam(self,sId):
        ...
        self.readbuf[:] = []
        for x in range(26):
            self.readbuf.append(self.ser.read())
